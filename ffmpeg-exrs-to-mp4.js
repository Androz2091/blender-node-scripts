...
const command = `ffmpeg -apply_trc iec61966_2_1 -r 24 -start_number ${minFrame} -i input/%04d.exr -i sound.mp3 c:v libx264 -crf 20 -c:a aac -strict -2 output/${maxOut+1}.mp4`;
